%%% -------------------------------------------------------------------
%%% Author  : Joq Erlang
%%% Description : ci machine
%%%  Test controller 
%%%  Use cases
%%%  1) Node Up -> Down
%%%  2) Node Down Up -> Up
%%%  3) Loading application and Node down
%%%  4) Applicaion running and Node down
%%%  Kill node - test change node
%%%%%%  1) Using unit test program for the service
%%%  2) Load and start -> do testing -> stop unload
%%% Created : 10 dec 2012
%%% -------------------------------------------------------------------
-module(ci).
